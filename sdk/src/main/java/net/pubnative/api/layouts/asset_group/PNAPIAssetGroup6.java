...
public class PNAPIAssetGroup6 extends PNAPIAssetGroup implements PNAPIAdModel.Listener {
    ...
    public PNAPIAssetGroup6(Context context) {
        super(context);
    }
    ...
    protected void loadView() {
        ...
        mRoot = (RelativeLayout) LayoutInflater.from(getContext()).inflate(R.layout.pubnative_asset_group_6, this, true);
