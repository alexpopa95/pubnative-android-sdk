...
public class PNAPIAssetGroup9 extends PNAPIAssetGroup implements PNAPIAdModel.Listener {

    protected RelativeLayout mRoot;
    protected ImageView      mBanner;
    protected RelativeLayout mContentInfo;

    public PNAPIAssetGroup9(Context context) {
        super(context);
    }
    ...
    public void load() {
        ...
        mRoot = (RelativeLayout) LayoutInflater.from(getContext()).inflate(R.layout.pubnative_asset_group_9, this, true);
