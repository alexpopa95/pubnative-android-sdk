...
public class PNAPIAssetGroup3 extends PNAPIAssetGroup implements PNAPIAdModel.Listener, VASTPlayer.Listener {
    ...
    protected void loadView() {
        ...
        mRoot = (RelativeLayout) LayoutInflater.from(getContext()).inflate(R.layout.pubnative_asset_group_3, this, true);
