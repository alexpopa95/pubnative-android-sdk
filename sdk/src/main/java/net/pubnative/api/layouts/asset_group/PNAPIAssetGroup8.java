...
public class PNAPIAssetGroup8 extends PNAPIAssetGroup implements PNAPIAdModel.Listener {

    protected RelativeLayout mRoot;
    protected WebView        mBanner;
    protected RelativeLayout mContentInfo;

    public PNAPIAssetGroup8(Context context) {
        super(context);
    }
    ...
    public void load() {
        ...
        mRoot = (RelativeLayout) LayoutInflater.from(getContext()).inflate(R.layout.pubnative_asset_group_8, this, true);
